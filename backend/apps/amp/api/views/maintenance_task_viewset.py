...
from apps.amp.api.serializers.maintenance_task_serializer import (
...
class MaintenanceTaskViewSet(viewsets.ModelViewSet):
    queryset = MaintenanceTask.objects.select_related("aircraft").order_by(
        "-created_at"
    )
    ...
    def create(self, request, *args, **kwargs):
        ...
        AuditService.log_create(
            user=request.user, instance=instance, after=serializer.data
        )
    ...
    def recalculate_status(self, request, pk=None):
        ...
        status_result = DueCalculationService.calculate_task_status(task, aircraft)
